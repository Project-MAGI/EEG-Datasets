...
1. [TDBrain Dataset](https://brainclinics.com/resources/) The TDBrain dataset is a dataset of EEG data for 1200 subjects. (need interporlation)
...
3. **LaBram, NeuroLM Pretrained**, **Benchmark Dataset** [SEED-IV](http://bcmi.sjtu.edu.cn/~seed/seed-iv.html): 15 subjects were shown video clips eliciting happy/sad/neutral/fear emotions, and EEG was recorded over 62 channels (with eye-tracking) for 3 sessions per subject (24 trials per session).
4. **LaBram, NeuroLM Pretrained**, **Benchmark Dataset** SEED-FRA, SEED-GER
...
### Error-Related Potentials (ErrP) and Visually Evoked Potentials (VEPs)
2. [MAMEM SSVEP](https://www.physionet.org/content/mssvepdb/1.0.0/)
...
### Visual Stimulus
  ...
  8. [THINGS-EEG](https://figshare.com/articles/dataset/THINGS-EEG/14721282), [THINGS-EEG2](https://osf.io/3jk45/)
...
3. [Freiburg epilepsy dayaset](http://epilepsy.uni-freiburg.de/freiburg-seizure-prediction-project/eeg-database)
4. [ADHD Dataset](https://nda.nih.gov/study.html?id=1938)
5. [pre- and postsurgical EEG recorded from epilepsy patients and HFO markings](https://gin.g-node.org/USZ_NCH/Scalp_EEG_HFO)
6. [A dataset of neonatal EEG recordings with seizures annotations](https://zenodo.org/records/2547147)
7. [Resting State EEG Biomarkers of Cognitive Decline (PLOS ONE - INSPECDS)](https://data.mendeley.com/datasets/wttpypkctg/2)
8. [CHB-MIT Scalp EEG Database](https://www.physionet.org/content/chbmit/1.0.0/) a collection of EEG recordings of 22 pediatric subjects with intractable seizures
9. [I-CARE: International Cardiac Arrest REsearch consortium Database](https://www.physionet.org/content/i-care/2.1/)
10. [Deep Sleep Slow Osciallation](https://challengedata.ens.fr/challenges/10): 10 seconds of recording starting 10 seconds before the end of a slow oscillation. Data is recorded to predict whether or not a slow oscillation will be followed by another one in the sham condition, i.e., without any stimulation.
11. [DREAM: A Dream EEG and Mentation Database](https://bridges.monash.edu/projects/The_Dream_EEG_and_Mentation_DREAM_database/158987)
12. [SLEEP Dataset](https://sleeptight.isr.uc.pt/)
13. **LaBram, NeuroLM pretrained** [Siena Scalp EEG Database](https://physionet.org/content/siena-scalp-eeg/1.0.0/)
...
3. [Monitoring ErrP in a target selection task](http://bnci-horizon-2020.eu/database/data-sets): 6 subjects with 64 EEG electrodes, watching a cursor move towards a target square, and elicited responses are labeled based on whether the cursor moves in right or wrong direction. [[Dataset Description]](https://lampx.tugraz.at/~bci/database/013-2015/description.pdf) and other BNCI Horizon 2020
